# Tuya IoTOS Embeded Demo BLE Mercury-Switch
...
This Demo is based on the Tuya Smart Cloud Platform, the Tuya Smart APP, and the IoTOS Embeded Ble SDK, and uses the Tuya BLE series module to quickly set up a mercury switch demo to report the current switch status in real time.
