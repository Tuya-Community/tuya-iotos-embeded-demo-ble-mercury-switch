...
static const char auth_key_test[] = "uY8olGkjMTjAy3iizCoHqxf6pYIVe8Lz";
static const char device_id_test[] = "tuyab0b31b56e740";
static const uint8_t mac_test[6] = {0x52,0x30,0x31,0x4D,0x23,0xDC}; //The actual MAC address is : 66:55:44:33:22:11 ;DC,23,4D,30,88,A2
...
void app_exe()
{
	if (clock_time_exceed(last_clock, 1000000)) { //500ms更新
		last_clock = clock_time();
		mercury_switch_task();
	}
